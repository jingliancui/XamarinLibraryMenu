...
---------|----------|---------|----------|----------
 ...
 JPush<br>(极光推送) | [JCore 2.3.4](https://www.nuget.org/packages/XamarinLibrary.Xamarin.Android.Jcore/)<br>[JPush 3.6.0](https://www.nuget.org/packages/XamarinLibrary.Xamarin.Android.Jpush/) | Not Bind | [Demo URL](https://github.com/jingliancui/XamarinFormsJPushSample) |❌
 AppCenter| | | |
 MJRefresh |  |  |  ||
