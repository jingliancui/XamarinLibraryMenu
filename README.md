...
---------|----------|---------|----------|----------|----------
 ...
 JPush<br>(极光推送) |Community| [JCore 2.3.4](https://www.nuget.org/packages/XamarinLibrary.Xamarin.Android.Jcore/)<br>[JPush 3.6.0](https://www.nuget.org/packages/XamarinLibrary.Xamarin.Android.Jpush/) | Not Bind | [Demo URL](https://github.com/jingliancui/XamarinFormsJPushSample) |❌
 AppCenter| Official|| | |
 MJRefresh |Community|  |  |  ||
 Tencent OpenSDK<br>(腾讯OpenSDK)|Community|||
 Tencent X5 WebView<br>(腾讯X5内核)|Community|||
 Tencent Bugly<br>(腾讯Bugly)|Community|||
 Font|Official|||
 ChatKit|Community|||
 SmartRefreshLayout|Community|||
 gRPC||||
